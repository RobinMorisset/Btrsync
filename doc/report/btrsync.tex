...
synchronization, only set reconciliation. We do not deal with other set reconciliation algorithms which try to achieve better
...
The computational complexity of MTZ is therefore TODOfabrice, which is not as good as
our complexity of TODOfabrice. However, our better complexity bound comes from
optimizations, all of which see (except, of course, the ones of
Section~\ref{sec:choicep}) could also be applied to MTZ.
