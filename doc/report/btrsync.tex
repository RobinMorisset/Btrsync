...
\begin{itemize}
  ...
  \item We explain in Section~\ref{hashing} how \df can be extended with hash
    ...
    points of this analysis (TODO: lesquels?!) apply no matter the choice of the underlying set
...
\bottomrule
  ...
  \begin{tablenotes}
    ...
    \item[c] only for $p_i$ prime or equivalent TODO;
    \item[d] only for $p_i = 2^{ut_i}$. TODO: dans ce cas, pourquoi ça apparaît dans la colonne basic ?
    \item[e] using advanced algorithms in~\cite{pan2004rational,wang2003acceleration} --- naive extended GCD leads $(uT_i)^2$. TODO: cette footnote n'est pas référencée ?
  \end{tablenotes}
 \end{threeparttable}
