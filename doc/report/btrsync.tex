...
Let also suppose we have a collision-resistant hash function $\Hash$ which takes as input any bit string and output a short binary string of, for example, $160$-bits\footnote{TODO: comment on such hash function for Antoine}.
