...
our complexity of $\Oapp(n u)$ (if we forget the cost of hashing which is not a part of the set reconciliation protocol itself). However, our better complexity bound comes from
